// scikit-learn's ENGLISH_STOP_WORDS, exported verbatim from the installed sklearn used by
// the original Streamlit RAG app. Kept identical so TF-IDF retrieval here matches Python exactly.
export const ENGLISH_STOP_WORDS: ReadonlySet<string> = new Set([
  ...
  "everyone", "everything", "everywhere", "except", "few", "fifteen", "fifty", "fill", "find",
